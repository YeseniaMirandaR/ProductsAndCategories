...
<html>
	...
	<body>
		<div class="w-50 container">
			...
			<h3 class="p-3 bg-secondary rounded text-white">Category</h3>
			<h3 class="p-2">${ category.name }</h3>
			<h3 class="p-3 bg-secondary rounded text-white">Products</h3>
			<ul>
			<c:forEach items="${ category.products }" var="product">
				<li>${ product.name }</li>			
			</c:forEach>
			</ul>
			<h3 class="p-3 bg-secondary rounded text-white">Add Products</h3>
